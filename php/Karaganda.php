...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/karag.jpg);
...
<header>
        <nav>
            <ul>
                <li><a href="#about">About Karaganda</a></li>
                <li><a href="#economy">Economy of Karaganda</a></li>
    ...
    <!-- Famous Places Section -->
    <section id="places">
        <h2>Famous Places in Karaganda</h2>
