...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/aktobe.jpg);
...
<header>
        <nav>
            <ul>
                <li><a href="#about">About Aktobe</a></li>
                <li><a href="#economy">Economy of Aktobe</a></li>
    ...
    <section id="about">
        <h2>About Aktobe</h2>
        <p>Aktobe, the capital of Kazakhstan, is a city of innovation, modernity, and rich history. It is known for its futuristic architecture, cultural landmarks, and as a hub for political and economic activities.</p>
