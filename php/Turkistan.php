...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/tur.jpg);
...
<header>
    ...
    <!-- Famous Places Section -->
    <section id="places">
        <h2>Famous Places in Turkistan</h2>
