...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/kyz.jpg);
...
<header>
    ...
    <section id="main-banner">
        <h1>Welcome to Kyzylorda!</h1>
        <p>Explore the heart of Kazakhstan, a city of modern architecture and rich culture.</p>
    </section>

    <!-- About Section -->
    <section id="about">
        <h2>About Kyzylorda</h2>
        <p>, the capital of Kazakhstan, is a city of innovation, modernity, and rich history. It is known for its futuristic architecture, cultural landmarks, and as a hub for political and economic activities.</p>
    ...
    <!-- Famous Places Section -->
    <section id="places">
        <h2>Famous Places in Kyzylorda</h2>
