...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/tr.jpg);
...
<header>
        <nav>
            <ul>
                <li><a href="#about">About Taraz</a></li>
                <li><a href="#economy">Economy of Taraz</a></li>
    ...
    <section id="about">
        <h2>About Taraz</h2>
        <p>Taraz, the capital of Kazakhstan, is a city of innovation, modernity, and rich history. It is known for its futuristic architecture, cultural landmarks, and as a hub for political and economic activities.</p>
    ...
    <!-- Famous Places Section -->
    <section id="places">
        <h2>Famous Places in Taraz</h2>
        <div class="place-card">
            <h3>Shahristan Monument</h3>
            <img src="/VSK2/progect/baiterek.jpg" alt="Bayterek Monument">
            <p>The iconic symbol of Astana, representing the ancient tree of life.</p>
        </div>
        <div class="place-card">
            <h3>Mart</h3>
            <img src="/VSK2/progect/khan.jpg" alt="Khan Shatyr Entertainment Center">
            <p>A modern shopping and entertainment complex in the shape of a giant tent.</p>
        </div>
        <div class="place-card">
            <h3>Pyramid</h3>
            <img src="/VSK2/progect/pira.jpg" alt="Pyramid of Peace and Accord">
...
function submitRating() {
    ...
    if (rating <= 3) {  
        ...
        document.getElementById("message").innerText = "Thank you! We're glad you love Taraz!";
    }
