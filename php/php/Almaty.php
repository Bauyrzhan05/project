...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/img/h3.jpg);
...
<body>
    ...
    <section class="places">
        ...
        <div class="row">
            <div class="place-col">
                <img src="/VSK2/progect/img/m.jpg" alt="">
                <div class="layer">
                    <h3>Medeu Skating Rink</h3>
                </div>
            </div>
            <div class="place-col">
                <img src="/VSK2/progect/img/L.jpg" alt="">
                <div class="layer">
                    <h3>Big Almaty Lake</h3>
                </div>
            </div>
            <div class="place-col">
                <img src="/VSK2/progect/img/p0.jpg" alt="">
                <div class="layer">
