...
/* Main Banner */
#main-banner {
    background-image: linear-gradient(rgba(61, 54, 54, 0.658),rgba(0,0,0,0.5)),url(/VSK2/progect/ast.jpg);
...
<header>
        <nav>
            <ul>
                <li><a href="#about">About Astana</a></li>
                <li><a href="#economy">Economy of Astana</a></li>
    ...
    <section class="places">
        <h1>Famous Places in Astana</h1>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Architecto praesentium velit nobis iure, tenetur perspiciatis. </p>
        <div class="row">
            <div class="place-col">
                <img src="https://www.astanahotels.ru/wp-content/uploads/2023/09/4etgw34.webp" alt="" class="img">
                <div class="layer">
                    <h3>Bayterek Monument</h3>
                </div>
            </div>
            <div class="place-col">
                <img src="https://sputnik.kz/img/old/126/91/1269120_379:0:1896:1517_1920x0_80_0_0_cbf4284dc8ba08d295c1aa209f73f532.jpg" alt="">
                <div class="layer">
                    <h3>Khan Shatyr</h3>
                </div>
            </div>
            <div class="place-col">
                <img src="/VSK2/progect/img/pira.jpg" alt="">
                <div class="layer">
                    <h3>Pyramid</h3>
                </div>
            </div>
